...
/**
 * Abstract class that represents a PC which may host one or more OPC servers.
 * Provides means of getting a list of OPC servers on the host and creating
 * connections to OPC servers.
 */
class COPCHost
{
  public:
...
/**
 * Used for accessing OPC servers on a remote host. Make use of OPCenum to
 * browse servers.
 */
...
/**
 * Used for accessing OPC servers on a local (this) host. Uses the Component
 * Categories manger to enumerate the OPC servers on the local machine.
 */
